...
def get_comparison_functions():
    ...
    return {
        ...
        "date_signature_sous_traitant": compare_normalized_string,
        "date_signature_mandataire": compare_normalized_string,
        "date_signature_administration": compare_normalized_string,
