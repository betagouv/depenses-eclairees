...
""",
    ...
    "montant_ht": {
     ...
     - Extraire le montant exprimé en euros ou en écriture littérale, et mettre le en chiffres en euros.
...
""",
    ...
    "rib_acte_engagement": {
        "consigne": """RIB
     Définition : Compte à créditer indiqué dans l'acte d'engagement.
     Indices : 
     - Rechercher le RIB dans la section dédiée à la sous-traitance.
     - Ne rien renvoyer si aucun RIB trouvé.
     Format : l'IBAN du compte à créditer.
""",
        "search": "",
        "output_field": "rib_acte_engagement"
    },
}
